...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<User> saveUser(@RequestBody @Valid UserPostRequest userPostRequest) {
    ...
    @PutMapping
    public ResponseEntity<Void> replaceUser(@RequestBody @Valid UserPutRequest userPutRequest) {
